...
__.maybeMustache     = v => __.isString(v) && v.indexOf('{') !== -1 && v.indexOf('}') !== -1
...
__.isVisible = v => __.isFunction(v) ? v() : false === v ? false : true
...
__.return = (func, _this) => {
  _this = _this || this;
  return __.isFunction(func) ? func.call(_this) : func }
